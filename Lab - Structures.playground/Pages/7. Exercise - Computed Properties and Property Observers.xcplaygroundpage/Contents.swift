...
struct Height {
    var heightInInches: Double {
      didSet{if heightInCentimeters != heightInInches*2.54{ heightInCentimeters = heightInInches*2.54}}
    }
    
    var heightInCentimeters: Double {
        didSet{if heightInInches != heightInCentimeters/2.54{heightInInches = heightInCentimeters/2.54}}
    }
