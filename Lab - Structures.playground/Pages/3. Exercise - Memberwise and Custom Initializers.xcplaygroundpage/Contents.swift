...
var favoriteBook = Book(title: "windixe", authour:"sam", pages: 9, price: 9.0)
...
var dell = Laptop(yearPurchased: 2004)
var Hp = Laptop(yearPurchased: 2006)
/*:
...
var H1 = Height(heightInInches: 65)
print(H1.heightInCentimeters)
...
var myHeight = Height(heightInInches: 73.2)
